...
public class MyEntityWolf extends EntityTameable
{
    ...
    public MyEntityWolf(World par1World)
    {
        super(par1World);
     ...
     */
    public MyEntityWolf spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        MyEntityWolf entitywolf = new MyEntityWolf(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal par1EntityAnimal)
    {
        ...
        else if (!(par1EntityAnimal instanceof MyEntityWolf))
        {
            return false;
        }
        else
        {
            MyEntityWolf entitywolf = (MyEntityWolf)par1EntityAnimal;
    ...
    public boolean func_142018_a(EntityLivingBase par1EntityLivingBase, EntityLivingBase par2EntityLivingBase)
    {
        ...
        {
            if (par1EntityLivingBase instanceof MyEntityWolf)
            {
                MyEntityWolf entitywolf = (MyEntityWolf)par1EntityLivingBase;

/**
 *	TROUBLESHOOTING 8 INSTRUCTIONS
 *-----------------------------------
 *	1.	Open EntityTroubleCow.java
 *	2. 	Change the Trouble Cow's behavior to be like an Enderman
 *	3.	Run Minecraft and open the Troubleshooting 8 World
 *	4. 	See the Trouble Cow teleport
 */
